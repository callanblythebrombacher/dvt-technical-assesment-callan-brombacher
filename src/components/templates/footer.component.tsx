...
import {AiFillFacebook, BiSearchAlt, FiTwitter, SiInstagram, TbBrandTiktok} from "react-icons/all";
    ...
    return(
        <footer>
            ...
            <div className={'other-pages-list-wrapper'}>
                ...
                {
                    helper.footerNav.map((value:{link:string, text:string}, index:number)=>{
                           return(
                                   <Link className={'other-pages-list-item'} href={value.link} key={index} >
                                        <p>{value.text}</p>
                                    </Link>
                           )
                    })
